## This script performs developmental projections of tumor cells onto developmental reference (Fig. 1f and E2b)
...
# FIG 1F - Project tumor metaprograms onto reference Nowakowski 2017+Eze et al. 2021 (TIME) -----------------------------------
...
# EXTENDED FIG 2B - Project tumor metaprograms onto reference Nowakowski 2017+Eze et al. 2021-----------------------------------
