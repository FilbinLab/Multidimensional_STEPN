...
## Projecting Early Development dataset by AgePCW
...
p <- p + theme(plot.margin = margin(10,10,10,40))
p
ggsave(plot = p, "/n/scratch/users/c/cao385/ST_samples_earlyDev_projection_AgePCW.png", width=9.5, height=18, dpi = 1200)
```
