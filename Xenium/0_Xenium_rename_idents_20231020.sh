...
#SBATCH -o /n/scratch/users/s/sad167/EPN/Xenium/logs/sbatch_out_1020.out		# File to which standard out will be written
#SBATCH -e /n/scratch/users/s/sad167/EPN/Xenium/logs/sbatch_errors_1020.err 		# File to which standard err will be written
