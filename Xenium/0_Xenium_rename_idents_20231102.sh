...
#SBATCH -o /n/scratch/users/s/sad167/EPN/Xenium/logs/sbatch_out_1102.out		# File to which standard out will be written
#SBATCH -e /n/scratch/users/s/sad167/EPN/Xenium/logs/sbatch_errors_1102.err 		# File to which standard err will be written
