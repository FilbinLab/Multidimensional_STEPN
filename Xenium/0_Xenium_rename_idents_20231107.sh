...
#SBATCH --mem 200G 		# amount of memory requested
#SBATCH --job-name Xenium_rename_idents 		# Job name
#SBATCH -o /n/scratch/users/s/sad167/EPN/Xenium/logs/sbatch_out_1107.out		# File to which standard out will be written
#SBATCH -e /n/scratch/users/s/sad167/EPN/Xenium/logs/sbatch_errors_1107.err 		# File to which standard err will be written
