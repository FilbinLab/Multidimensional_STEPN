...
analysis_dir  <- file.path(base_dir, 'analysis/20231109__203408__BT1804_BT2169')
...
samples <- c('0010498-Region_1', '0010498-Region_2', '0010775-Region_1')
names(samples) <- c('0010498-Region_1', '0010498-Region_2', '0010775-Region_1')
...
resolutions_to_use <- c('SCT_snn_res.0.3', 'SCT_snn_res.0.4', 'SCT_snn_res.0.4')
...
annotation_clusters <- list (
  '0010498-Region_1' = c('0' = 'Ependymal-like', 
                         ...
                         '18' = 'Immune',
                         '19' = 'Oligodendrocytes'),
  '0010498-Region_2' =  c('0' = 'Neuroepithelial-like', 
                          '1' = 'Neuroepithelial-like', 
                          '2' = 'Brain?', 
                          '3' = 'Immune', 
                          '4' = 'Brain?', 
...
# Read data
for (i in seq_along(samples)) {
  data <- qread(file.path(base_dir, paste0('data/processed_data_Carlos/20231109__203408__BT1804_BT2169/', names(samples)[i], '/', names(samples)[i], '.qs')))
