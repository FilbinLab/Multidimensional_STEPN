...
DotPlot(data, cols = c('lightgrey', 'red'),features = gene_list, assay = 'SCT', scale = TRUE) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.text=element_text(size = 8))
ggsave(file.path(plot_dir, "1_DotPlot_0010553-Region_3_11EP22.pdf"), width=13, height=4)
...
write_csv(cell_id, file.path(data_dir, "0010553-Region_3_11EP22_cell_id.csv"))
...
DotPlot(data, cols = c('lightgrey', 'red'),features = gene_list, assay = 'SCT', scale = TRUE) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1), axis.text=element_text(size = 8))
ggsave(file.path(plot_dir, "1_DotPlot_0010553-Region_4_EP41.pdf"), width=13, height=4)
...
write_csv(cell_id, file.path(data_dir, "0010553-Region_4_EP41_cell_id.csv"))
