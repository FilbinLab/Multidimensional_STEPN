...
library(knitr)
opts_chunk$set(
  echo = TRUE, cache = FALSE, warning = FALSE, comment = FALSE)
```
...
# create custom key-value pairs for 'high', 'low', 'mid' expression by fold-change
  ...
  keyvals <- ifelse(
    markers_coculture$avg_log2FC < -2, 'grey',
      ifelse(markers_coculture$avg_log2FC > 2, 'red',
        'black'))
  keyvals[is.na(keyvals)] <- 'black'
  names(keyvals)[keyvals == 'red'] <- 'Upregulated in coculture'
  names(keyvals)[keyvals == 'grey'] <- 'Upregulated in monoculture'
...
EnhancedVolcano::EnhancedVolcano(markers_coculture,
                                 ...
                                 FCcutoff = 2, # fold change cutoff (default)
                                 title = NULL, # no title
